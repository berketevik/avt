        ...
        <div className="row">
          ...
          <div className="col col-d-12 col-t-12 col-m-12 border-line-v">
            <div className="skills-list">
              <ul>
                <li className="border-line-h">
                  <div className="name">Yöneticilik Becerileri </div>
                  <div className="progress">
                    <div className="percentage" style={{ width: "80%" }} />
                  </div>
                </li>
                <li className="border-line-h">
                  <div className="name">Stratejik Yaklaşım Becerisi</div>
                  <div className="progress">
                    <div className="percentage" style={{ width: "90%" }} />
                  </div>
                </li>
                <li className="border-line-h">
                  <div className="name">Analitik ve Mantıksal Muhakeme</div>
                  <div className="progress">
                    <div className="percentage" style={{ width: "80%" }} />
                  </div>
                </li>
                <li>
                  <div className="name">İletişim Becerileri</div>
                  <div className="progress">
                    <div className="percentage" style={{ width: "100%" }} />
                  </div>
                </li>
                <li>
                  <div className="name">Teknik-Teknolojij Beceriler</div>
                  <div className="progress">
                    <div className="percentage" style={{ width: "90%" }} />
                  </div>
                </li>
          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            <div className="skills-list dotted">
              <div className="skill-title border-line-h">
                ...
                <div className="name">Yabancı Diller</div>
              </div>
              <ul>
                <li className="border-line-h">
