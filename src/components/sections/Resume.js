          ...
          <div className="resume-items">
            <div className="resume-item border-line-h active">
              <p>
                ...
                ve yurt dışında uzunca bir süre çalıştığımdan kurumsal
                firmalarda iletişimin nasıl olması gerektiği konusunda deneyim
                sahibiyim. Üretimin ve Ür-Ge’nin içinde bir mühendis olarak
                süreçleri başta bizzat yürüttüm, ilerleyen yıllar ile birlikte
                kadrolar yönettim ve nihayetinde tüm tecrübelerin birleşimi ile
                firmaların operasyonel süreçleriniden ve üst yönetiminden
                sorumlu oldum.
              </p>
            </div>
          </div>
          ...
          <div className="resume-items">
            ...
            <div className="resume-item border-line-h">
              ...
              <div className="company">
                ...
                of Business Administration ortak MBA programı
              </div>
            </div>
            <div className="resume-item border-line-h">
