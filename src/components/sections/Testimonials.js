          ...
          <div className="revs-carousel default-revs">
            <Swiper {...props} className="owl-carousel">
                  ...
                  <div className="user">
                    <div className="info">
                      ...
                      <div className="company">
                        REFERANS NOKTASI PAZARLAMA ve MARKA DANIŞMANLIĞI LTD.
                        ŞTİ. - Yönetim Danışmanı
                      </div>
                    </div>
                    <div className="clear" />
                  </div>
              ...
              <SwiperSlide className="item">
                <div className="revs-item">
                  <div className="text">
                    Volkan Bey, iletişimi düzgün, detay odaklı, problem çözme
                    becerisi yüksek, sorumluluk almaktan çekinmeyen, en alt
                    kademedeki çalışanın işini yerinde öğrenerek tüm üretim
                    sürecine hakim olacak kadar detaya inebilen, işine hakim,
                    kurumsal yapının ne demek olduğunu bilen, çalışkan bir
                    arkadaşımızdır.
                  </div>
                  <div className="user">
                    <div className="info">
                      ...
                      <div className="company">
                        Yaparlar Tarım Ve İnşaat Malzemeleri A.Ş. - İnsan
                        Kaynakları Müdürü
                      </div>
                    </div>
                    <div className="clear" />
              ...
              <SwiperSlide className="item">
                <div className="revs-item">
                  <div className="text">
                    Volkan Bey, işinde oldukça deneyimli, kararlı, istikrarlı,
                  ...
                  <div className="user">
                    <div className="info">
                      ...
                      <div className="company">
                        TürkAkım Gaz Taşıma AŞ - Procurement Manager
                      </div>
                    </div>
                    <div className="clear" />
                  </div>
