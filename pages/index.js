...
const serviceList = [
  ...
  },
  {
    ...
    desc: "Yoğun adetlerde üretim yapan firmalarında tekrarlanabilirliğin önemli olduğu durumlaarda otmosaayonaa geçiş kararı verilmelidir.",
  },
  {
    icon: "fa fa-money",
    title: "Yalın Üretim",
  ...
  },
  {
    icon: "fa fa-trophy",
    title: "Kurumsallaşma",
    desc: "Şirketlerin genel kabul görmüş sistem, uygulama veya organizasyon oluşturma sürecidir. İşltmelerin daha verimli, tutarlı ve öngörülebilir bir şekilde çalışmasını desteklemek ve sürdürülebilirliğin sağlanabilmesi adına tasarlanmış kurallar, prosedürler ve yapılar oluşturmayı içerir.",
  },
  {
    icon: "fa fa-users",
